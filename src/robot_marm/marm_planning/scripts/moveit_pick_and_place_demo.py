...
class MoveItPickAndPlaceDemo:
    def __init__(self):
        ...
        box1_pose.pose.position.z = table_groud + table_size[2] + box1_size[2] / 2.0
        ...
        box2_pose.pose.position.z = table_groud + table_size[2] + box2_size[2] / 2.0
        ...
        target_pose.pose.position.z = table_groud + table_size[2] + target_size[2] / 2.0
        ...
        place_pose.pose.position.z = table_groud + table_size[2] + target_size[2] / 2.0
        ...
        if result == MoveItErrorCodes.SUCCESS:
            ...
            if result != MoveItErrorCodes.SUCCESS:
                rospy.loginfo("Place operation failer after " + str(n_attempts) + " attempts.")
        else:
